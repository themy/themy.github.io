...
;(function($, window, undefined) {
  var pluginName = 'scrollplugin',
      win = $(window);

  function scrollplugin(element, options) {
  ...
  scrollplugin.prototype = {
    ...
    scrollToID: function() { 
      var that = this;
      var position = $(this.element.data('id')).offset();
      $('body').animate({
        scrollTop: position.top
      }, 1000);
      window.console.log(position.top);
    },
    destroy: function() {
  ...
  $.fn[pluginName] = function(options, params) {
    return this.each(function() {
      ...
      if (!instance) {
        $.data(this, pluginName, new scrollplugin(this, options));
